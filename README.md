...
| `OVERTURE_RELEASE` | Overture sürümü (varsayılan `2026-09-23.0`). Sabit tutulur: "latest" yolu yok ve kategoriler sürümler arası değişebilir. **Overture eski sürümleri S3'ten siler** (yalnızca son ~2 sürüm kalır); silinen sürümde enrich 500 döner. Kategori `taxonomy.primary`'den okunur — eski `categories` sütunu `2026-09-23.0`'da kalktı |
